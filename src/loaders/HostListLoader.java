 ...
 * @author Hiro
 */
public class HostListLoader extends Application {

    @Override
    public void start(Stage primaryStage) throws Exception {
        URL url = new File("src/gui/missions/HostList.fxml").toURI().toURL();
    ...
    public static Parent GetRoot() {
        ...
        try {
            url = new File("src/gui/missions/HostList.fxml").toURI().toURL();
