...
public class DetaileAnnonceController implements Initializable {
    ...
    private void QRcode() {
        ...
        filePath = "C:\\ecosystemjava\\src\\res\\Annonce\\qrcphoto" + lbl_titre.getText() + ".png";
        int size = 250;
        String fileType = "png";
    ...
    private void creatpdf() {
        ...
        try {
            ...
            String out = "D:\\Annonce\\Annonce" + titre + ".pdf";
            ...
            Logger.getLogger(DetaileAnnonceController.class.getName()).log(Level.SEVERE, null, ex);
